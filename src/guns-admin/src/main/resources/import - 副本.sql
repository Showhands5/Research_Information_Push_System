...
-- My records
INSERT INTO `t_sys_menu`(`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `code`, `icon`, `ismenu`, `isopen`, `levels`, `name`, `num`, `pcode`, `pcodes`, `status`, `tips`, `url`) VALUES (100, NULL, NULL, 1, '2020-05-01 07:48:05', 'paper', '', 1, NULL, 1, '论文推送', 12, '0', '[0],', 1, NULL, '/paper');
INSERT INTO `t_sys_menu`(`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `code`, `icon`, `ismenu`, `isopen`, `levels`, `name`, `num`, `pcode`, `pcodes`, `status`, `tips`, `url`) VALUES (101, NULL, NULL, NULL, NULL, 'area', '', 1, NULL, 2, '领域设置', 11, 'paper', '[0],[paper],', 1, NULL, '/paper/area');
INSERT INTO `t_sys_menu`(`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `code`, `icon`, `ismenu`, `isopen`, `levels`, `name`, `num`, `pcode`, `pcodes`, `status`, `tips`, `url`) VALUES (102, NULL, NULL, NULL, NULL, 'area_add', '', 0, NULL, 3, '添加领域', 1, 'area', '[0],[paper],[area],', 1, NULL, '/paper/area/add');
INSERT INTO `t_sys_menu`(`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `code`, `icon`, `ismenu`, `isopen`, `levels`, `name`, `num`, `pcode`, `pcodes`, `status`, `tips`, `url`) VALUES (103, NULL, NULL, NULL, NULL, 'area_update', '', 0, NULL, 3, '修改领域', 2, 'area', '[0],[paper],[area],', 1, NULL, '/paper/area/update');
INSERT INTO `t_sys_menu`(`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `code`, `icon`, `ismenu`, `isopen`, `levels`, `name`, `num`, `pcode`, `pcodes`, `status`, `tips`, `url`) VALUES (104, NULL, NULL, NULL, NULL, 'area_delete', '', 0, NULL, 3, '删除领域', 3, 'area', '[0],[paper],[area],', 1, NULL, '/paper/area/delete');
INSERT INTO `t_sys_menu`(`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `code`, `icon`, `ismenu`, `isopen`, `levels`, `name`, `num`, `pcode`, `pcodes`, `status`, `tips`, `url`) VALUES (105, NULL, NULL, 1, '2020-05-01 10:32:38', 'paperPaper', '', 1, NULL, 2, '论文查看', 6, 'paper', '[0],[paper],', 1, NULL, '/paper/paper');
INSERT INTO `t_sys_menu`(`id`, `create_by`, `create_time`, `modify_by`, `modify_time`, `code`, `icon`, `ismenu`, `isopen`, `levels`, `name`, `num`, `pcode`, `pcodes`, `status`, `tips`, `url`) VALUES (106, 1, '2020-05-01 10:18:52', 1, '2020-05-01 10:18:52', 'paper_add', '', 0, NULL, 3, '论文添加', 6, 'paperPaper', '[0],[paper],[paperPaper],', 1, NULL, '/paper/paper/add');
